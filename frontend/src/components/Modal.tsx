...
export default function Modal({
  ...
  const titleId = useId();
  const dialogLabelId = title ? titleId : undefined;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        ...
        className="relative z-10 w-full max-w-md rounded-xl bg-white p-6 shadow-lg dark:bg-zinc-900 dark:ring-1 dark:ring-zinc-700"
      >
        {title && (
          <h2 id={titleId} className="mb-4 text-lg font-semibold text-black dark:text-zinc-100">
            {title}
          </h2>
        )}
